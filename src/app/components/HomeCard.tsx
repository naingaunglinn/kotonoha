  ...
  return (
    <div className="max-w-7xl mx-auto pt-20 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-xl text-[#1F150C]/80">Master Japanese by following the official JLPT path from N5 to N1.</p>
      </div>
      <div className="mt-20">
        <h2 className="text-3xl font-bold tracking-tight text-[#1F150C] text-center mb-10">Start with the Basics</h2>
      ...
      <div className={"mt-20"}>
        <h2 className="text-3xl font-bold tracking-tight text-[#1F150C] text-center mb-10">Prepare for the JLPT</h2>
