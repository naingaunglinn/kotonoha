      ...
      <div className="bg-[#F5EDED] w-full max-w-2xl max-h-[90vh] rounded-3xl shadow-2xl overflow-y-auto">
        ...
        {phase === 'setup' && (
          <div className="p-6 space-y-6">
            ...
            <div>
              <label className="block text-sm font-bold text-[#3E3636]/60 mb-2 uppercase tracking-wider">Kanji Source</label>
          ...
          return (
            <div className="p-6 space-y-5">
              ...
              <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
                {mode === 'kanji-meaning' ? (
                  <>
                    <h3 className="text-8xl font-bold text-[#3E3636] leading-none mb-3">{q.kanji.word}</h3>
                    <button
                      onClick={() => speak(q.kanji.word_kana || q.kanji.word || '')}
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F5EDED] hover:bg-[#D72323] hover:text-white text-[#3E3636] text-sm font-medium transition-all"
                    >
                  ...
                  <>
                    <div className="text-xs font-bold text-[#3E3636]/50 uppercase tracking-wider mb-2">English meaning</div>
                    <h3 className="text-2xl font-bold text-[#3E3636]">{q.kanji.meaning}</h3>
                  </>
                )}
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-2xl font-bold text-[#3E3636]">{r.question.kanji.word}</span>
                        <span className="text-sm text-[#3E3636]/60">{r.question.kanji.meaning}</span>
                      </div>
                    ...
                    {expanded && (
                      <div className="px-3 pb-3 space-y-1.5 text-xs text-[#3E3636]/80 border-t border-black/5 pt-2">
                        ...
                        <p><span className="font-bold text-[#D72323]">On&apos;yomi:</span> {r.question.kanji.onyomi || '—'}</p>
                        <p><span className="font-bold text-[#D72323]">Kun&apos;yomi:</span> {r.question.kanji.kunyomi || '—'}</p>
                        <button
                          onClick={() => speak(r.question.kanji.word_kana || r.question.kanji.word || '')}
                          className="inline-flex items-center gap-1.5 mt-1 px-2.5 py-1 rounded-full bg-white border border-black/5 text-[#3E3636] hover:bg-[#D72323] hover:text-white transition-colors"
                        >
